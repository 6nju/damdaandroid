      ...
      <View style={styles.wrapper}>
          <View style={[styles.itemcenter,{marginBottom: 60}]}>
		   ...
		   <Header navigation={this.props.navigation} user={this.state.user}/>
			...
			<TouchableOpacity style={[styles.logout, {backgroundColor: '#000', color: '#000', marginBottom: 20}]}     onPress={() => this.props.navigation.navigate('NewAddress')}>
                  				<Text style={[styles.logout_text, { color: '#fff',fontSize:17} ]}>주소추가</Text>
                		</TouchableOpacity>
