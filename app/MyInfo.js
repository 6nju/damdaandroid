          ...
          <View style={[styles.itemcenter,{marginBottom: 60}]}>
		   ...
		   <Header navigation={this.props.navigation} user={this.state.user}/>
      		...
      		<View style={{paddingTop: 10, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: '#ddd'}}>
				...
				<Text style={{width: width, textAlign:'center', fontWeight:'normal',fontSize:20,}}>
				﻿내 정보
				</Text>
			</View>
			
          	<Text style={{width: width, textAlign:'left', fontWeight:'bold', marginLeft: 15, marginTop: 20,fontSize:18}}>
				﻿기본정보
				</Text>
			<Text style={{width: width, textAlign:'left', fontWeight:'normal',fontSize:15, marginLeft: 15, marginTop: 20,}}>
				﻿성
				</Text>
          		...
          		<View style={styles.section1}>
						...
						<Text style={{width: width, textAlign:'left', fontWeight:'normal', marginLeft: 27, marginTop: 20, fontSize: 15}}>
				﻿이름
				</Text>
                		<View style={styles.section2}>
						...
						<Text style={{width: width, textAlign:'left', marginLeft: 15, marginTop: 20, fontSize: 15}}>
							﻿ID/Email
						</Text>
						<Text style={{textAlign:'left', fontWeight:'normal', position: 'absolute', right: 15, marginLeft: 15, marginTop: 20, fontSize: 16}}>
							﻿{this.state.user_login.email}
						</Text>
						
						</View>
						<Text style={{width: width, textAlign:'left', marginLeft: 25, marginTop: 20, fontSize: 15}}>
							﻿생년월일
						</Text>
						...
						<Text style={{textAlign:'left', marginLeft: 10, marginTop: 20, fontSize: 15, marginTop: 26}}>
							년
						</Text>
						</View>
						...
						<Text style={{textAlign:'left', marginLeft: 10, marginTop: 20, fontSize: 15, marginTop: 25}}>
							월
						</Text>
						</View>
                		...
                		<TouchableOpacity style={[styles.logout, {backgroundColor: '#fc6833', color: '#000',borderRadius:0}]}   onPress={this._login}>
                  				<Text style={[styles.logout_text, { color: '#fff',fontSize:20,} ]}>수정완료</Text>
                		</TouchableOpacity>
