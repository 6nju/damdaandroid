...
export default class NewTow extends React.Component {
	constructor(props) {
        super(props)
        this.state = {
            page:1,
	...
	_showPage(id){
	  ...
	  apis.getRecruitment(id).then(res => {
          	...
          	<ScrollView contentInsetAdjustmentBehavior="automatic" style={styles.scrollview_section}>
		              ...
		              <TouchableOpacity style={styles.new} onPress={() =>this.props.navigation.navigate('Newdetail', {newItem: val})}>
		              		<View style={styles.new_image}>
		              				<Image 
									 source={{uri: 'https://api.hoplongtech.com/uploads/news/' + val.image_cover,width: width*.5 - 20, height: 120*(width*.5 -20)/168}}/>
		              		</View>
