...
<View style={styles.navbar}>
                                ...
                                <View style={{backgroundColor:'#e6e6e6',height:10,width:width,flex:3,borderTopRightRadius:50,borderWidth:1,borderColor:'#e6e6e6'}}></View>
                                <View style={{backgroundColor:'#FFF',height:10,width:width,flex:1,}}></View>
                                <View style={{backgroundColor:'#e6e6e6',height:10,width:width,flex:3.1,borderTopLeftRadius:50,borderWidth:1,borderColor:'#e6e6e6'}}></View>
                                </View>
                                    ...
                                    <View style={[styles.footersectionmiddle,]} >
                                    	<TouchableOpacity style={{borderWidth:1,borderColor:'#e6e6e6',borderRadius:40,backgroundColor:'#fff',padding:5,alignItems:'center',justifyContent:'center',position:'absolute',bottom:0,left:3}} onPress={this.changeLayoutOneTow}>
                                        <Image
                                            style={[styles.simage,{height:65,width:65,}]}
                                            source={require('../../imgs/icon_normal__.png')}
                                        />
                                        </TouchableOpacity>
                                    </View>
                                    <TouchableOpacity style={styles.footersection1} onPress={() =>this.props.navigation.navigate('Login')}>
