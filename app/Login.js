      ...
      <View style={{marginTop:width*0.1}}></View>
          <ScrollView >
			...
			<TouchableOpacity style={[styles.header_left, { marginTop: 10, zIndex: 10,position: 'absolute', top: -5}]} onPress={() => this.props.navigation.pop()}>
				...
				<Text style={{width: width, textAlign:'center', fontWeight:'bold',color:'#ff5500'}}>
				로그인 / 회원가입 
				</Text>
			</View>
          	...
          	<View style={styles.form}>
          		<View style={styles.section1}>
						...
						<TouchableOpacity style={[{color: '#000'}]} onPress={this._RestPassword}>
                  				<Text style={[{ color: '#ff5500', width: width, marginLeft: 30, marginTop: 10}]}>잊어버리셨습니까?</Text>
                		</TouchableOpacity>
						
						<TouchableOpacity style={[styles.logout, {backgroundColor: '#fff34f', color: '#000'}]}   onPress={this.onPressLogin}>
								<Image
