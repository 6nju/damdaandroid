		...
		<View style={styles.wrapper}>
          ...
          <View style={[styles.itemcenter,{marginBottom: 60}]}>
			...
			<View style={{paddingTop: 10, paddingBottom: 10}}>
				...
				<Text style={{width: width, textAlign:'center', fontWeight:'normal',fontSize:18,}}>
				﻿﻿내 주문
				</Text>
			</View>
			...
			<View style={[styles.item_section, {borderTopWidth: 0, paddingTop: 0, marginTop: 0}]}>
			  ...
			  <TouchableOpacity style={[{width: width,backgroundColor:'#fff', borderBottomWidth: 1, borderColor: '#ddd', paddingTop:10, paddingBottom: 10}]}  onPress={this._showTab.bind(this, index_)}>
					  ...
					  <Text style={{color: '#000', marginLeft: 15, marginTop: 5, width: width}}>
                        ﻿주문 <Text style={{color: '#eb5a2b', marginLeft: 15, marginTop: 5,fontWeight:'bold'}}>{val.increment_id}</Text>{'\n'}
                        ﻿<Text style={{color: '#868893', marginLeft: 15, marginTop: 5, fontSize: 13}}>{val.created_at}</Text>
                    </Text>
						<Text style={{color: '#000', marginLeft: 15, marginTop: 5, fontSize: 13, position:'absolute', right: 30, top: 21}}>{text}</Text>
			  ...
			  <View style={{width:width, height: val.show ? null : 0, overflow: 'hidden', }}>
					   <View style={[styles.item_section,{width: width,borderBottomWidth:1,borderBottomColor:'#ddd' }]}>
