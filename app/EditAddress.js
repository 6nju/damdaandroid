    ...
    return (
      <View style={styles.wrapper}>
        ...
        <View style={{width: width,flexDirection: 'row',flexWrap: 'wrap'}}>
			   <Text style={{width: width, textAlign:'left', fontWeight:'normal', marginLeft: 15, marginTop: 20, fontSize: 15}}>
				* 주소
				</Text>
						...
						<TouchableOpacity style={[styles.input, { zIndex: 10,height: 36,  marginLeft: 0, width:width*0.4 -20 }]} onPress={this.changeLayoutOne}>
		                      <Text style={{textAlign:'center', fontWeight:'bold', marginTop: 10, fontSize: 13, width:width*0.4 -20}}>
				우편번호 검색
				</Text>
		                  </TouchableOpacity>
						</View>
